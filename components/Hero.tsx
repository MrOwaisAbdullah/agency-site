  ...
  return (
    <section className="relative text-gray-600 overflow-hidden z-0 -mt-24">
      <HeroHighlight>
        ...
        <motion.div
          className="absolute animate-float top-[40%] right-[30%] w-[300px] h-[300px] rounded-full bg-purple-500/15 blur-[90px]"
          ...
          <div className="sm:entrance-left lg:flex-grow md:w-1/2 lg:pr-16 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center lg:w-3/5">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-2">
              ...
              <Link href="/contact" className="scroll-smooth duration-300">
                <button className="group flex items-center text-white bg-gradient-to-br from-blue-900 via-accent to-blue-700 hover:from-blue-800 py-2 px-8 rounded-full font-medium md:text-lg transition-all duration-300 transform shadow-lg shadow-accent/20">
